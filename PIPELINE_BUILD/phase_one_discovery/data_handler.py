...
class HurricaneDataHandler():
    ...
    def __init__(self, config=config):
        ...
        self.ids_and_labels = self.raw_training[0][['tweet_id', 'class_label']]
    ...
    def augment_training_text(self):
        ...
        try:
            df = self.collect_tweet_dfs(target, 0)
        except Exception as e:        
            print("Error in augmenting the training text")
            print(e)
        df_return = df.merge(self.ids_and_labels, on='tweet_id', how='inner')
        return df_return
